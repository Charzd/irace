...
"minNbSurvival", "nbConfigurations", "mu", "confidence", "n_objectives"), type = c("x",
...
"--mu", "--confidence", "--n-objectives"), default = c(NA, NA, NA, "", "", "./scenario.txt",
...
"0", "0", "0", "0", "5", "0.95", "1"), domain = c(NA, NA, NA, NA,
...
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), description = c("Show this help.",
...
"Confidence level for the elimination test.", "Number of objectives to optimize.")), row.names = c(".help",
...
"cappingType", "boundType", "boundMax", "boundDigits", "boundPar",
"boundAsTimeout", "postselection", "aclib", "nbIterations", "nbExperimentsPerIteration",
"minNbSurvival", "nbConfigurations", "mu", "confidence", "n_objectives")
