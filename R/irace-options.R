...
"minNbSurvival", "nbConfigurations", "mu", "confidence", "n_objectives", "archiveBudgetPercent", "bootstrapCount", "bootstrapAlpha"), type = c("x",
...
"i", "i", "r", "i", "r", "i", "r"), short = c("-h", "-v", "-c", "-i", "", "-s", "",
"-p", "", "", "", "-l", "", "", "", "", "", "", "", "", "", "",
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
"", "", "", "", "", "", "-q", "", "", "", "", "-e", "", "", "",
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
...
"--mu", "--confidence", "--n-objectives", "--archive-budget", "--n-bootstrap", 
"alpha-bootstrap"), default = c(NA, NA, NA, "", "", "./scenario.txt",
...
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), description = c("Show this help.",
...
"Confidence level for the elimination test.", "Number of objectives to optimize.", "Percentage of budget reserved for the non-dominated archive leveling phase.",
"Number of resamples used in bootstrap dominance evaluation.", "Minimum dominance percentage required to eliminate a configuration in bootstrapping.")), row.names = c(".help",
...
"cappingType", "boundType", "boundMax", "boundDigits", "boundPar",
"boundAsTimeout", "postselection", "aclib", "nbIterations", "nbExperimentsPerIteration",
"minNbSurvival", "nbConfigurations", "mu", "confidence", "n_objectives", "archiveBudgetPercent", "bootstrapCount", "bootstrapAlpha"), class = "data.frame")
...
"cappingType", "boundType", "boundMax", "boundDigits", "boundPar",
"boundAsTimeout", "postselection", "aclib", "nbIterations", "nbExperimentsPerIteration",
"minNbSurvival", "nbConfigurations", "mu", "confidence", "n_objectives", "archiveBudgetPercent", "bootstrapCount", "bootstrapAlpha")
